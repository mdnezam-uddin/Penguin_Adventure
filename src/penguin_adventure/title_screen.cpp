...
#include "penguin_adventure/profile.hpp"
#include "penguin_adventure/profile_manager.hpp"
...
TitleScreen::TitleScreen(Savegame &savegame, bool christmas) : m_savegame(savegame),
...
void TitleScreen::setup_sector(Sector &sector)
{
...
void TitleScreen::draw(Compositor &compositor)
{
  ...
  // Logo, frame, and text removed for simplified interface
}
...
void TitleScreen::update_level(float dt_sec)
{
...
void TitleScreen::refresh_copyright_text()
{
  // cppcheck-suppress unknownMacro
  m_copyright_text = "Penguin Adventure " PACKAGE_VERSION "\n" +
                     _("Copyright") + " (c) 2003-2025 Penguin Adventure Devel Team\n" +
                     _("This game comes with ABSOLUTELY NO WARRANTY. This is free software, and you are welcome to\n"
                       "redistribute it under certain conditions; see the license file for details.\n");
}

void TitleScreen::set_frame(const std::string &image)
{
