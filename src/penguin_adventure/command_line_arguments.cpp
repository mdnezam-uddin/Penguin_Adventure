...
CommandLineArguments::print_help(const char* arg0) const
{
  std::cerr
    ...
    << _("  -v, --version                Show Penguin Adventure version and quit") << "\n"
    << _("  --verbose                    Print verbose messages") << "\n"
    << _("  --debug                      Print extra verbose messages") << "\n"
    << _("  --log-tinygettext            Show tinygettext logs") << "\n"
    << _("  --print-datadir              Print Penguin Adventure's primary data directory.") << "\n"
    << _("  --acknowledgements           Print the licenses of libraries used by Penguin Adventure.") << "\n"
    << "\n"
    << _("Video Options:") << "\n"
    << _("  -f, --fullscreen             Run in fullscreen mode") << "\n"
    << _("  -w, --window                 Run in window mode") << "\n"
    << _("  -g, --geometry WIDTHxHEIGHT  Run Penguin Adventure in given resolution") << "\n"
    << _("  -a, --aspect WIDTH:HEIGHT    Run Penguin Adventure with given aspect ratio") << "\n"
    ...
    // l10n: Keep PENGUIN_ADVENTURE2_USER_DIR untranslated
    << _("  PENGUIN_ADVENTURE2_USER_DIR           Directory for user data (savegames, etc.)" ) << "\n"
    // l10n: Keep PENGUIN_ADVENTURE2_DATA_DIR untranslated
    << _("  PENGUIN_ADVENTURE2_DATA_DIR           Directory for the game's data files" ) << "\n"
    << "\n"
    << std::flush;
}
