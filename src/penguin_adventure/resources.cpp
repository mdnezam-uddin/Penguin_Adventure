...
Resources::load(bool reload)
{
  ...
  default_font.reset(new TTFFont("fonts/Penguin Adventure-Medium.ttf", 18, 1.25f, 2, 1));
...
{
  return get_font_for_locale(locale) != "fonts/Penguin Adventure-Medium.ttf";
}
...
Resources::get_font_for_locale(const tinygettext::Language& locale)
{
  ...
  return "fonts/Penguin Adventure-Medium.ttf";
}
