...
#include "penguin_adventure/menu/editor_levelset_menu.hpp"
#include "penguin_adventure/menu/editor_delete_level_menu.hpp"
...
EditorLevelSelectMenu::create_item(bool worldmap)
{
  ...
  if (worldmap)
  {
    Dialog::show_message(_("Share this worldmap under license CC-BY-SA 4.0 International (advised).\n"
                           ...
                           "Penguin Adventure authors take no responsibility for your choice of license."));
  }
  else
  {
