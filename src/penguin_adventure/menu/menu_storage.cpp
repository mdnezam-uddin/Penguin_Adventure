...
#include "penguin_adventure/menu/addon_browse_menu.hpp"
#include "penguin_adventure/menu/cheat_menu.hpp"
#include "penguin_adventure/menu/debug_menu.hpp"
#include "penguin_adventure/menu/contrib_menu.hpp"
#include "penguin_adventure/menu/custom_menu_menu.hpp"
#include "penguin_adventure/menu/editor_converters_menu.hpp"
#include "penguin_adventure/menu/editor_menu.hpp"
#include "penguin_adventure/menu/editor_level_menu.hpp"
#include "penguin_adventure/menu/editor_level_select_menu.hpp"
#include "penguin_adventure/menu/editor_levelset_select_menu.hpp"
#include "penguin_adventure/menu/editor_new_levelset_menu.hpp"
#include "penguin_adventure/menu/editor_objectgroup_menu.hpp"
#include "penguin_adventure/menu/editor_settings.hpp"
#include "penguin_adventure/menu/editor_temp_save_menu.hpp"
#include "penguin_adventure/menu/editor_tilegroup_menu.hpp"
#include "penguin_adventure/menu/editor_sector_menu.hpp"
#include "penguin_adventure/menu/editor_sectors_menu.hpp"
#include "penguin_adventure/menu/game_menu.hpp"
#include "penguin_adventure/menu/integrations_menu.hpp"
#include "penguin_adventure/menu/joystick_menu.hpp"
#include "penguin_adventure/menu/keyboard_menu.hpp"
#include "penguin_adventure/menu/language_menu.hpp"
#include "penguin_adventure/menu/main_menu.hpp"
#include "penguin_adventure/menu/multiplayer_menu.hpp"
#include "penguin_adventure/menu/multiplayer_players_menu.hpp"
#include "penguin_adventure/menu/options_select_menu.hpp"
#include "penguin_adventure/menu/particle_editor_menu.hpp"
#include "penguin_adventure/menu/particle_editor_save_as.hpp"
#include "penguin_adventure/menu/particle_editor_open.hpp"
#include "penguin_adventure/menu/profile_menu.hpp"
#include "penguin_adventure/menu/video_system_menu.hpp"
#include "penguin_adventure/menu/web_asset_menu.hpp"
#include "penguin_adventure/menu/worldmap_menu.hpp"
#include "penguin_adventure/menu/worldmap_cheat_menu.hpp"
...
MenuStorage::create(MenuId menu_id)
{
  switch (menu_id)
  {
    ...
    case EDITOR_SETTINGS_MENU:
      return std::make_unique<EditorSettings>();
      
    case EDITOR_TEMP_SAVE_MENU:
      return std::make_unique<EditorTempSaveMenu>();
