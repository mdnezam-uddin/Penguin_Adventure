...
Sector::finish_construction(bool editable)
{
  ...
  // I added this to fix https://github.com/Penguin Adventure/penguin_adventure/issues/1378
...
Sector::convert_tiles2gameobject()
{
  ...
  for (auto& tm : get_objects_by_type<TileMap>())
  {
    ...
    // See https://github.com/Penguin Adventure/penguin_adventure/issues/1378 for details
